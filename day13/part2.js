        ...
        while(true){
            ...
            if(op == 1){
                ...
                if(this.dispCmd == 0){
                    ...
                    this.tmpID = this.m(A);
                    if(this.tmpX == -1 && this.tmpY == 0)console.log("SCORE: "+this.tmpID);
                    // draw tile
                    this.blocks[[this.tmpX, this.tmpY]] = this.tmpID;

                    if(this.tmpID == 4) this.ball = this.tmpX;
                    if(this.tmpID == 3) this.paddle = this.tmpX;

                    if(this.ball < this.paddle)this.yojstick = -1;
                    if(this.ball > this.paddle)this.yojstick = 1;
                    if(this.ball == this.paddle)this.yojstick = 0;
